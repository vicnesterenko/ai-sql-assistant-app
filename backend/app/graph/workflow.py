...
builder.add_conditional_edges('validate_sql', route_validation, {'valid': 'assess_risk', 'retry': 'generate_sql', 'error': 'handle_error'})
...
builder.add_conditional_edges('await_approval', route_approval, {'wait': END, 'approved': 'execute_query', 'rejected': 'format_result'})
builder.add_conditional_edges('execute_query', route_execution, {'ok': 'format_result', 'retry': 'generate_sql', 'done': 'format_result'})
builder.add_edge('format_result', END)
builder.add_edge('handle_error', END)

# Built-in LangGraph checkpointer for local development. The project also persists JSON state in PostgreSQL
# so approval polling can resume after API calls without replaying previous nodes.
...
resume_builder.add_conditional_edges('await_approval', route_approval, {'wait': END, 'approved': 'execute_query', 'rejected': 'format_result'})
resume_builder.add_conditional_edges('execute_query', route_execution, {'ok': 'format_result', 'retry': 'generate_sql', 'done': 'format_result'})
resume_builder.add_edge('generate_sql', 'validate_sql')
resume_builder.add_conditional_edges('validate_sql', route_validation, {'valid': 'assess_risk', 'retry': 'generate_sql', 'error': 'handle_error'})
resume_builder.add_conditional_edges('assess_risk', route_risk, {'execute': 'execute_query', 'high': 'request_approval'})
